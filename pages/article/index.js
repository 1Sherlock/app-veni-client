                        ...
                        <div className="news link-effect post-list">
                            <div className="news__row">
                                ...
                                <a className="news__wrap avtor" href="/owner/2">
                                    ...
                                    <span className="avatar_name">Ш. Алина</span>
                                </a>
                            </div>
                            <div className="news__subtitle post_title">
                                <span className="span">Жамол Насыров назначен новым хокимом Бухары.</span>
                                <div>Жамол Носиров занимал должность заместителя хокима Бухарской области с 2017 по 2020
                                    год.
                                </div>
                            </div>
