            ...
            <div className="main-container container">
                <div className="row">
                    ...
                    <div className="col col--large">
                        <div className="avtor_banner">
                            <img alt="" className="avtor_banner__back" src="/uploads/users/2_wallpaper.png" />
                                <div className="avtor_banner__box">
                                    <div className="avtor_banner__img">
                                        <img alt="" src="/uploads/users/2.png" />
                                    </div>
                                    <h5>Ш.Алина
                                        <span>
                        ...
                        <div className="advice">
                            <app-adfox-banner _nghost-serverapp-c10="" id="adfox_160601177015139307">
                                <div id="AdFox_banner_3313531303" style={{width: "100%"}}><a
                                    ...
                                    alt="" width="100"
                                    style={{width: "100%", height: "auto", verticalAlign: "middle", border: "0px"}} /></a></div>
